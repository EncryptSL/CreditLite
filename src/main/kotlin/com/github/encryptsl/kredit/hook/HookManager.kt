package com.github.encryptsl.kredit.hook

import com.github.encryptsl.kredit.hook.placeholderapi.KreditPlaceholderAPI

class HookManager(private val creditLite: com.github.encryptsl.kredit.CreditLite) {
    ...
    fun hookPAPI() {
        if (isPluginInstalled("PlaceholderAPI")) {
            ...
            creditLite.logger.info("###################################")
            KreditPlaceholderAPI(creditLite, com.github.encryptsl.kredit.CreditLite.PAPI_VERSION).register()
        } else {
            creditLite.logger.info("###################################")
