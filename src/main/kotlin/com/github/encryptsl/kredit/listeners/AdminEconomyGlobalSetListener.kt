...
import com.github.encryptsl.kredit.api.events.AdminGlobalSetEvent
...
class AdminEconomyGlobalSetListener(private val creditLite: com.github.encryptsl.kredit.CreditLite) : Listener {
    @EventHandler
