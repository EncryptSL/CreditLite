...
import com.github.encryptsl.kredit.api.events.AdminKreditWithdrawEvent
...
class AdminEconomyMoneyWithdrawListener(private val creditLite: com.github.encryptsl.kredit.CreditLite) : Listener {
