...
import com.github.encryptsl.credit.api.events.AdminKreditSetEvent
...
class AdminEconomyMoneySetListener(private val creditLite: com.github.encryptsl.credit.CreditLite) : Listener {
