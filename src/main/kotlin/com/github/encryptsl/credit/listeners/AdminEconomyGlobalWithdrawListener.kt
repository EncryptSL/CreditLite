...
import com.github.encryptsl.credit.api.events.AdminGlobalWithdrawEvent
...
class AdminEconomyGlobalWithdrawListener(private val creditLite: com.github.encryptsl.credit.CreditLite) : Listener {
    @EventHandler
